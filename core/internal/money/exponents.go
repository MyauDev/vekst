...
// artefact: it does not come from /proto and is not covered by the codegen
// drift gate. See openspec design D5/Q4.
//
// Source: the ISO 4217 active currency & funds code list maintained by the
// ISO 4217 Maintenance Agency, transcribed 2026-09-02. ISO revises this list
// periodically -- currencies are added and withdrawn -- so a currency missing
// here may simply postdate this transcription; update the table and this
// date together, never one without the other.
...
// Exponent returns the number of minor-unit digits for code, and false when
// code is not in the table. An unknown code is never defaulted to 2: that is
// how a KWD amount (exponent 3) becomes wrong by a factor of ten in a report
// nobody re-checks.
