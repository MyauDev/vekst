...
// Registry bug in @bklit/line-chart: the published path is one directory too
// deep (`../components/shimmering-text` from here resolves to
// `src/components/components/...`, which does not exist). Corrected by hand;
