...
const messages = {
  en: {
    ...
    "chart.cashflow.note":
      "Money that actually moved, month by month — including what the P&L leaves out. Transfers between your own accounts are counted apart, in the reconciliation strip.",
    ...
    "chart.netresult.note": "Profit or loss in each month of the range.",
  ...
  ru: {
    ...
    "chart.cashflow.note":
      "Деньги, которые реально двигались, по месяцам — включая то, что не попадает в ОПиУ. Переводы между своими счетами считаются отдельно, в блоке сверки.",
    ...
    "chart.netresult.note": "Прибыль или убыток в каждом месяце периода.",
