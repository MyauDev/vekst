...
const messages = {
  en: {
    ...
    // Every chart card says in one line what it is showing. A chart whose
    // title is two words and whose y-axis is money is a chart the reader has
    // to reverse-engineer before they can trust it.
    "chart.expenses.title": "Top expense categories",
    "chart.expenses.note": "Sections that cost money over the range, largest first.",
    "chart.cashflow.title": "Money in and out",
    "chart.cashflow.note":
      "Money that actually moved, month by month — including what the P&L leaves out. Both bars are sizes: out is drawn as what left, not as a negative. Transfers between your own accounts are counted apart, in the reconciliation strip.",
    ...
    "chart.netresult.note":
      "Profit or loss in each month of the range. A loss is drawn as its size, in the loss colour — this chart's value axis starts at zero.",
    "chart.netresult.series": "Net result",
    "chart.netresult.profit": "Profit",
    "chart.netresult.loss": "Loss",
    "chart.revenueExpense.title": "Revenue against expenses",
    "chart.revenueExpense.note": "The P&L's own revenue and costs, month by month.",
    "chart.revenueExpense.revenue": "Revenue",
    "chart.revenueExpense.expenses": "Expenses",
    "chart.trend.title": "Category trend",
    "chart.trend.note": "Each section over the range, each on its own scale.",
    ...
    // The P&L's own line names. The wire sends the taxonomy's abbreviation --
    // `core/internal/report/pnl.go`'s `sectionLabels` is literally "CS",
    // "OCS", "OIE", "FR", "CIT", and `Chain` is "GM", "NM", "CM", "IBT", "NI"
    // -- because those codes are what the accounting structure is written in
    // and renaming one would move a figure to a different line. They are not
    // what an owner reads. The abbreviation stays on screen beside the name
    // (an accountant anchors on it); the name is what the row is called.
    "line.01": "Net sales",
    "line.02": "Cost of sales",
    "line.03": "Other cost of sales",
    "line.04": "Operating expenses",
    "line.05": "Other income and expenses",
    "line.06": "Financial result",
    "line.07": "Corporate income tax",
    "line.08": "Capital expenditure",
    "line.09": "Outside the P&L",
    "line.91": "Gross margin",
    "line.92": "Net margin",
    "line.93": "Contribution margin",
    "line.94": "Profit before tax",
    "line.95": "Net profit",

    // Leaf category names, the same idea as `line.*` one level down: the
    // wire sends `categories.name`, which stays whatever the founder's own
    // accounting called it (`eval/`'s own README -- these are real vendor
    // and department names, not authored prose) and stays English, since
    // renaming a leaf's stored name is a taxonomy change, not a translation.
    // `categoryName()` in `app/categoryName.ts` resolves the name shown on
    // screen from the code instead, the same fallback the P&L lines use for
    // a code this build has never heard of: an org-scoped leaf a customer's
    // own data adds after this catalogue was written renders as whatever the
    // backend called it, in whichever language that happened to be written.
    "category.0101": "Software development",
    "category.02": "Cost of sales",
    "category.030101": "Promotion commission",
    "category.0401010101": "Salary",
    "category.0401010201": "1C Cloud",
    "category.0401010202": "Accounting services",
    "category.0401010203": "Audit",
    "category.0401010204": "Bank commission",
    "category.0401010205": "E-document workflow",
    "category.0401010206": "Time & attendance",
    "category.0401020101": "Salary",
    "category.0401020201": "Business trips",
    "category.0401020202": "Communication",
    "category.0401020203": "Domain",
    "category.0401020204": "Education",
    "category.0401020205": "File storage",
    "category.0401020206": "Hosting",
    "category.0401020207": "IT equipment repair",
    "category.0401020208": "Office rent",
    "category.0401020209": "Office supplies",
    "category.0401020210": "Small IT equipment",
    "category.0401020211": "Sport",
    "category.0401020212": "Stationery",
    "category.0401030101": "HR tools",
    "category.0401040101": "Claims",
    "category.0401040102": "Court",
    "category.0401040103": "Legal entity rent",
    "category.0401040104": "Legal — other",
    "category.0401040105": "Relocation",
    "category.0401050101": "Education",
    "category.0401050102": "HeadHunter",
    "category.0402010101": "Salary",
    "category.0402010201": "Content creation",
    "category.0402010202": "Google Ads",
    "category.0402010203": "MarTech tools",
    "category.0402010204": "Marketing channels",
    "category.0402010205": "Marketplace advertising",
    "category.0402010206": "Merch for employees",
    "category.0402010207": "SEO",
    "category.0402020101": "Salary",
    "category.0402020201": "Sales activities",
    "category.0402020202": "Sales tools",
    "category.0403": "Payroll tax to distribute",
    "category.0404": "Payroll to distribute",
    "category.0405010101": "Education",
    "category.0405010102": "Salary",
    "category.0405010201": "Design tools",
    "category.0405010202": "Production tools",
    "category.0405010203": "Salary",
    "category.0406": "Twoj StartUp",
    "category.050101": "Expenses compensation",
    "category.050102": "Expenses for 2022",
    "category.05010301": "1%, Hi-Tech Park",
    "category.05010302": "Advance tax",
    "category.05010303": "Hi-Tech Park membership",
    "category.05010304": "Other",
    "category.05010305": "VAT",
    "category.050104": "Tax fines",
    "category.050201": "CIT refund",
    "category.050202": "Return of payment",
    "category.060101": "Currency exchange",
    "category.060102": "Currency revaluation",
    "category.060201": "Interest received",
    "category.07": "Corporate income tax",
    "category.08": "Capital expenditure",
    "category.09": "Outside the P&L",
  ...
  ru: {
    ...
    "chart.expenses.note": "Статьи, которые стоили денег за период, от крупных к мелким.",
    "chart.cashflow.title": "Поступления и списания",
    "chart.cashflow.note":
      "Деньги, которые реально двигались, по месяцам — включая то, что не попадает в ОПиУ. Оба столбца — величины: списания нарисованы тем, сколько ушло, а не минусом. Переводы между своими счетами считаются отдельно, в блоке сверки.",
    ...
    "chart.netresult.note":
      "Прибыль или убыток в каждом месяце периода. Убыток рисуется своей величиной, цветом убытка — ось значений здесь начинается с нуля.",
    "chart.netresult.series": "Итог",
    "chart.netresult.profit": "Прибыль",
    "chart.netresult.loss": "Убыток",
    "chart.revenueExpense.title": "Выручка и расходы",
    "chart.revenueExpense.note": "Выручка и расходы по ОПиУ, помесячно.",
    "chart.revenueExpense.revenue": "Выручка",
    "chart.revenueExpense.expenses": "Расходы",
    "chart.trend.title": "Динамика по категориям",
    "chart.trend.note": "Каждая статья за период, каждая в своём масштабе.",
    ...
    "line.01": "Выручка",
    "line.02": "Себестоимость продаж",
    "line.03": "Прочая себестоимость",
    "line.04": "Операционные расходы",
    "line.05": "Прочие доходы и расходы",
    "line.06": "Финансовые доходы и расходы",
    "line.07": "Налог на прибыль",
    "line.08": "Капитальные затраты",
    "line.09": "Вне ОПиУ",
    "line.91": "Валовая прибыль",
    "line.92": "Чистая маржа",
    "line.93": "Маржинальная прибыль",
    "line.94": "Прибыль до налогообложения",
    "line.95": "Чистая прибыль",

    "category.0101": "Разработка ПО",
    "category.02": "Себестоимость продаж",
    "category.030101": "Комиссия за продвижение",
    "category.0401010101": "Зарплата",
    "category.0401010201": "1С Облако",
    "category.0401010202": "Бухгалтерские услуги",
    "category.0401010203": "Аудит",
    "category.0401010204": "Банковская комиссия",
    "category.0401010205": "Электронный документооборот",
    "category.0401010206": "Учёт рабочего времени",
    "category.0401020101": "Зарплата",
    "category.0401020201": "Командировки",
    "category.0401020202": "Связь",
    "category.0401020203": "Домен",
    "category.0401020204": "Обучение",
    "category.0401020205": "Хранение файлов",
    "category.0401020206": "Хостинг",
    "category.0401020207": "Ремонт IT-оборудования",
    "category.0401020208": "Аренда офиса",
    "category.0401020209": "Офисные принадлежности",
    "category.0401020210": "Мелкое IT-оборудование",
    "category.0401020211": "Спорт",
    "category.0401020212": "Канцтовары",
    "category.0401030101": "HR-инструменты",
    "category.0401040101": "Претензии",
    "category.0401040102": "Суд",
    "category.0401040103": "Аренда (юр. лицо)",
    "category.0401040104": "Юридические — прочее",
    "category.0401040105": "Релокация",
    "category.0401050101": "Обучение",
    "category.0401050102": "HeadHunter",
    "category.0402010101": "Зарплата",
    "category.0402010201": "Создание контента",
    "category.0402010202": "Google Реклама",
    "category.0402010203": "MarTech-инструменты",
    "category.0402010204": "Маркетинговые каналы",
    "category.0402010205": "Реклама на маркетплейсах",
    "category.0402010206": "Мерч для сотрудников",
    "category.0402010207": "SEO",
    "category.0402020101": "Зарплата",
    "category.0402020201": "Мероприятия по продажам",
    "category.0402020202": "Инструменты продаж",
    "category.0403": "Налоги на ФОТ к распределению",
    "category.0404": "ФОТ к распределению",
    "category.0405010101": "Обучение",
    "category.0405010102": "Зарплата",
    "category.0405010201": "Инструменты дизайна",
    "category.0405010202": "Инструменты разработки",
    "category.0405010203": "Зарплата",
    "category.0406": "Twoj StartUp",
    "category.050101": "Компенсация расходов",
    "category.050102": "Расходы за 2022 год",
    "category.05010301": "1%, Парк высоких технологий",
    "category.05010302": "Авансовый налог",
    "category.05010303": "Членство в Парке высоких технологий",
    "category.05010304": "Прочее",
    "category.05010305": "НДС",
    "category.050104": "Налоговые штрафы",
    "category.050201": "Возврат налога на прибыль",
    "category.050202": "Возврат платежа",
    "category.060101": "Обмен валюты",
    "category.060102": "Переоценка валюты",
    "category.060201": "Полученные проценты",
    "category.07": "Налог на прибыль",
    "category.08": "Капитальные затраты",
    "category.09": "Вне ОПиУ",
