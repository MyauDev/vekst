...
func (f *File) getFromStringItem(index int) string {
	if f.sharedStringTemp != nil {
		// GO-2026-6452 / GHSA-fx5j-qcqg-grpf: index < 0 added locally, no
		// upstream release yet. See the replace directive in the repo's
		// go.mod for the vulnerability this closes.
